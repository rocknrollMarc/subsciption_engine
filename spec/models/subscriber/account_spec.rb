...
describe Subscriber::Account  do
  ...
  it 'created a schema' do
    account = Subscriber::Account.create!({
      :name => "First Account",
      :subdomain => "first"
    })
  ...
  it 'can be created with an owner' do
    ...
    account = Subscriber::Account.create_with_owner(params)
  ...
  it 'cannot create an account without a subdomain' do
    account = Subscriber::Account.create_with_owner
